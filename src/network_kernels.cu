...
void pull_updates(layer l)
{
    ...
    if(l.type == CONVOLUTIONAL){
        ...
        cuda_pull_array(l.weight_updates_gpu, l.weight_updates, l.n*l.size*l.size*l.size*l.c);
...
void push_updates(layer l)
{
    ...
    if(l.type == CONVOLUTIONAL){
        ...
        cuda_push_array(l.weight_updates_gpu, l.weight_updates, l.n*l.size*l.size*l.size*l.c);
...
void merge_updates(layer l, layer base)
{
    if (l.type == CONVOLUTIONAL) {
        ...
        axpy_cpu(l.n*l.size*l.size*l.size*l.c, 1, l.weight_updates, 1, base.weight_updates, 1);
        if (l.scale_updates) {
...
void distribute_updates(layer l, layer base)
{
    if (l.type == CONVOLUTIONAL) {
        ...
        copy_cpu(l.n*l.size*l.size*l.size*l.c, base.weight_updates, 1, l.weight_updates, 1);
        if (l.scale_updates) {
